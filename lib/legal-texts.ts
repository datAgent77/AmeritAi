export const legalTexts = {
  tr: {
    distanceSales: {
      ...
      lead: "İşbu sözleşme, 6502 sayılı Tüketicinin Korunması Hakkında Kanun ve Mesafeli Sözleşmeler Yönetmeliği'ne uygun olarak düzenlenmiştir.",
      content: `
          ...
          <p>SATICI tarafından sunulan yazılımın, tasarımın, kodların ve içeriğin tüm fikri mülkiyet hakları Userex Design Studio'ya aittir. ALICI, hizmeti yalnızca kendi kullanımı için satın almış olup, yazılımı kopyalayamaz, kiralayamaz, satamaz veya kaynak koduna dönüştürme (reverse engineering) işlemi yapamaz.</p>

          <h3>MADDE 7 – GİZLİLİK VE GÜVENLİK</h3>
          <p>ALICI'nın üyelik ve ödeme sırasında girdiği bilgiler, SATICI tarafından Gizlilik Politikası ve KVKK Aydınlatma Metni çerçevesinde korunmaktadır. Kredi kartı bilgileri sistemde saklanmamakta olup, ödemeler lisanslı ödeme kuruluşları altyapısı ile gerçekleştirilir.</p>

          <h3>MADDE 8 – UYUŞMAZLIKLARIN ÇÖZÜMÜ</h3>
          <p>İşbu sözleşmenin uygulanmasından doğabilecek uyuşmazlıklarda, Sanayi ve Ticaret Bakanlığı'nca ilan edilen değere kadar Tüketici Hakem Heyetleri ile İstanbul (Anadolu) Tüketici Mahkemeleri ve İcra Daireleri yetkilidir.</p>
    ...
    privacy: {
      ...
      lead: "Kişisel verilerinizin güvenliğine ve gizliliğine en üst düzeyde önem veriyoruz.",
      content: `
          <h3>1. VERİ SORUMLUSU</h3>
          <p>Kişisel verileriniz, veri sorumlusu sıfatıyla <strong>Userex Design Studio</strong> ("Şirket") tarafından, aşağıda açıklanan kapsamda işlenebilecektir.</p>
          <p className="text-sm text-muted-foreground mt-2">
            <strong>Adres:</strong> Caferağa Mh. Şifa Sk. No:19, Kadıköy / İstanbul / Turkey
          </p>

          <h3>2. İŞLENEN KİŞİSEL VERİLERİNİZ</h3>
          <p>Hizmetlerimizden yararlanmanız sırasında aşağıdaki verileriniz işlenebilmektedir:</p>
          <ul>
            <li><strong>Kimlik Bilgileri:</strong> Ad, soyad.</li>
            <li><strong>İletişim Bilgileri:</strong> E-posta adresi, telefon numarası.</li>
            <li><strong>İşlem Güvenliği Bilgileri:</strong> IP adresi, internet sitesi giriş-çıkış bilgileri, log kayıtları.</li>
            <li><strong>Müşteri İşlem Bilgileri:</strong> Sipariş bilgileri, talep ve şikayet bilgileri.</li>
          </ul>
          ...
          <ul>
            ...
            <li>Yasal yükümlülüklerin (5651 sayılı kanun, vergi mevzuatı vb.) yerine getirilmesi.</li>
            <li>Hizmet kalitesinin artırılması ve müşteri desteği sağlanması.</li>
          </ul>

          <h3>4. KİŞİSEL VERİLERİN AKTARILMASI</h3>
          <p>Verileriniz, yasal zorunluluklar dışında üçüncü kişilerle paylaşılmamaktadır. Ancak:</p>
          <ul>
            <li>Ödemelerin alınabilmesi için lisanslı ödeme kuruluşlarına (Iyzico, Stripe vb.),</li>
            <li>Yasal talepler gelmesi halinde yetkili kamu kurum ve kuruluşlarına,</li>
            <li>Teknik altyapı hizmeti alınan sunucu sağlayıcılarına (Gerekli güvenlik önlemleri altında) aktarılabilir.</li>
          </ul>

          <h3>5. VERİLERİN SAKLANMA SÜRESİ</h3>
          <p>Kişisel verileriniz, ilgili mevzuatta belirtilen veya işlendikleri amaç için gerekli olan süre kadar saklanacaktır. Üyelik sona erdikten sonra yasal saklama süreleri (örn. Ticaret Kanunu gereği 10 yıl) sonunda verileriniz anonimleştirilir veya imha edilir.</p>

          <h3>6. KVKK KAPSAMINDAKİ HAKLARINIZ</h3>
    ...
    terms: {
      ...
      content: `
          ...
          <ul>
            ...
            <li>Telif haklarını ihlal eden içerikler üretmek veya paylaşmak.</li>
            <li>Sistemi spam veya kötü niyetli botlarla manipüle etmek.</li>
          </ul>

          <h3>3. ÜYELİK VE HESAP GÜVENLİĞİ</h3>
          ...
          <p>İşbu sözleşmeden doğan ihtilaflarda Türkiye Cumhuriyeti Mahkemeleri ve İcra Daireleri yetkilidir.</p>

          <h3>8. DEĞİŞİKLİKLER</h3>
          <p>Userex Design Studio, bu sözleşme maddelerinde dilediği zaman değişiklik yapma hakkına sahiptir. Güncel sözleşme web sitesinde yayınlandığı tarihte yürürlüğe girer.</p>
      `
    }
  },
  en: {
    distanceSales: {
      title: "Standard Subscription Agreement",
      lead: "International Terms of Sale for SaaS Products.",
      content: `
          <h3>1. PARTIES</h3>
          ...
          <h3>4. REFUND POLICY (Digital Services)</h3>
          <p>As this is a digital service with instant access, there is strictly <strong>no right of withdrawal</strong> or "cooling-off period" once the service has been activated and used, consistent with EU Consumer Rights Directive (2011/83/EU) exceptions for digital content. By subscribing, you explicitly waive your right of withdrawal.</p>

          <h3>5. LICENSE AND RESTRICTIONS</h3>
          <p>Provider grants Subscriber a non-exclusive, non-transferable right to access and use the Service. Subscriber shall not reverse engineer, decompile, or attempt to discover the source code of the Service.</p>

          <h3>6. GOVERNING LAW</h3>
          <p>This Agreement shall be governed by the laws of the Republic of Turkey. However, international users are entitled to mandatory consumer protections applicable in their country of residence if required by international law. Disputes shall be resolved in Istanbul Courts or via arbitration.</p>
      `
    },
    privacy: {
      ...
      content: `
          ...
          <ul>
            ...
            <li><strong>Right to Erasure ("Right to be Forgotten"):</strong> Ask us to delete your data.</li>
    ...
    terms: {
      ...
      content: `
          ...
          <p>You agree not to use the Service for any illegal purpose or in any way that interrupts, damages, or impairs the service. You are responsible for safeguarding the password that you use to access the Service.</p>

          <h3>4. LIMITATION OF LIABILITY</h3>
          <p>In no event shall Userex Design Studio be liable for any indirect, incidental, special, or consequential damages resulting from your use of the service. The AI outputs are for informational purposes and should be verified.</p>
