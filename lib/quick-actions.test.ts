...
test("always localizes quick action text by module id and widget language", () => {
    const button = {
        id: "appointments",
        label: "Randevu Al",
    ...
    expect(getQuickActionDisplayLabel({ ...button, label: "Custom Turkish panel text" }, "en")).toBe("Book Appointment")
