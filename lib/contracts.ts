...
const DEFAULT_CONTRACT_TEMPLATES: Record<ContractTemplateType, ContractTemplateSeed> = {
    tenantAgreement: {
        ...
        title: "Tenant Hizmet Sozlesmesi",
        text: [
            "Vion AI tenant panelini kullanarak platform kosullarini kabul etmis olursunuz.",
            "",
            "1. Platform yalnizca yetkili kullanicilar tarafindan kullanilabilir.",
            "2. Musteri verileri ve isletme icerikleri dogru, guncel ve yetkili paylasim kapsaminda olmalidir.",
            "3. Vion AI; yasa disi, aldatıcı veya hak ihlali iceren kullanimlarda hizmeti kisitlayabilir.",
            "4. Tenant yoneticisi, kendi kullanicilarinin ve entegrasyonlarinin dogru yonetiminden sorumludur.",
            "5. Faturalama, plan sinirlari ve veri kullanimi secilen pakete gore uygulanir.",
        ].join("\n"),
    },
    partnerAgreement: {
        type: "partnerAgreement",
        title: "Partnerlik Sozlesmesi",
        text: [
            "Vion AI partner sistemi; yetkili partner hesaplari icin saglanan yonetim ve dagitim araclarini kapsar.",
            "",
            "1. Partner, yonettigi tenant hesaplariyla ilgili ticari ve operasyonel sorumluluklarini yerine getirir.",
            "2. Platform uzerinden gorulen bilgiler yalnizca yetkili ekip ve musteriler icin kullanilabilir.",
            "3. Partner komisyon ve paket gorunumleri yalnizca bilgilendirme amaclidir; nihai finansal mutabakat ayrica yapilir.",
            "4. Partner paneline erisim bu sozlesmenin kabulune baglidir.",
        ].join("\n"),
    },
    kvkkDefault: {
        type: "kvkkDefault",
        ...
        text: [
            "Bu sohbeti baslatmadan once kisisel verilerinizin Vion AI ve ilgili isletme tarafindan hizmet sunumu, destek ve kalite iyilestirme amaclariyla islenebilecegini kabul etmeniz gerekir.",
            "",
            "Devam ederek KVKK kapsamindaki aydinlatma metnini okudugunuzu ve gerekli durumlarda sizinle iletisime gecilebilecegini kabul etmis olursunuz.",
        ].join("\n"),
    },
}
