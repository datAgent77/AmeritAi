...
export default function SalesOptimizationPage() {
    ...
    useEffect(() => {
        ...
        // Listen for storage events (changes from other tabs/iframes)
    ...
    const addDiscountCode = () => {
        ...
        setConfig(prev => {
            ...
            // Auto-enable if any code is marked as auto (or legacy first item)
    ...
    const removeDiscountCode = (index: number) => {
        setConfig(prev => {
            ...
            // Auto-disable if no auto codes remain
            const shouldAutoOffer = updatedCodes.some((c, i) => c.usageType === 'auto' || (!c.usageType && i === 0))
                    ...
                    {config.discountCodes && (
                        <CardContent className="space-y-6">
                            ...
                            <div className="bg-slate-50/50 border rounded-xl p-5 transition-all">
                                <div className="">
                                    {/* Auto Offer Settings - Relocated Inside */}
                                    {/* Auto Offer Settings - Simplified & Conditional */}
                                    ...
                                    {/* Auto Offer Settings - Simplified & Clean */}
