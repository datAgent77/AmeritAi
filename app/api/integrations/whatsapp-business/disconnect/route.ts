...
import { buildDefaultWhatsAppBizConfig, buildWhatsAppBizStatus } from "@/lib/integrations/whatsapp-business/setup"
...
export async function POST(req: Request) {
    ...
    const nextConfig = await mergeOmniChannelConfig(adminDb, chatbotId, {
        whatsappBusiness: buildDefaultWhatsAppBizConfig(),
        whatsapp: {
            ...(omniConfig?.whatsapp || {}),
            enabled: false,
            accessTokenRef: null,
