...
import { buildDefaultInstagramDMConfig, buildInstagramDMStatus } from "@/lib/integrations/instagram-dm/setup"
...
export async function POST(req: Request) {
    ...
    const nextConfig = await mergeOmniChannelConfig(adminDb, chatbotId, {
        instagramDM: buildDefaultInstagramDMConfig(),
        instagram: {
            ...(omniConfig?.instagram || {}),
            enabled: false,
            accessTokenRef: null,
