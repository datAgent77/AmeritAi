...
export default function PersonalShopperPage() {
    ...
    return (
        <SolutionLayout
            ...
            icon={<ShoppingBag className="w-5 h-5 text-pink-600 dark:text-pink-400" />}
            features={[
                {
                    ...
                    icon: <ScanBarcode className="w-6 h-6 text-purple-600 dark:text-purple-400" />
                },
                {
                ...
                },
                {
                    ...
                    icon: <ShoppingBag className="w-6 h-6 text-pink-600 dark:text-pink-400" />
                }
            ]}
            promptExample={{
