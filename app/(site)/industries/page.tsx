                ...
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {sectors.map((sector, i) => (
                            <Link key={i} href={sector.href} className="group relative">
                                <div className="h-full bg-card border border-border hover:border-primary/50 hover:bg-muted/50 rounded-2xl p-8 transition-all duration-300 hover:-translate-y-1 flex flex-col items-start text-left">
                                    <div className="w-14 h-14 mb-6 flex items-center justify-start text-foreground group-hover:scale-110 transition-transform duration-300">
