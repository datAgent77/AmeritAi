...
export const metadata: Metadata = {
  ...
  description: "Transparent pricing for Vion AI. Choose from Starter, Growth, Business, and Enterprise plans. Start with a 14-day free trial. No credit card required.",
