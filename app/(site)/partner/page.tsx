...
const content = {
    tr: {
        ...
        hero_title: "AmeritAI ile Büyü, Birlikte Kazan",
        ...
        why_title: "Neden AmeritAI Partner'ı Olmalısınız?",
        why_items: [
            ...
            { icon: Crown, title: "Müşteri Sahipliği", desc: "Getirdiğiniz müşteri sizindir. 12 ay boyunca başka partner veya AmeritAI direkt satış ekibi müdahale edemez." },
            { icon: Globe, title: "Beyaz Etiket Seçeneği", desc: "Çözüm Partner olarak AmeritAI'u kendi markanızla sunabilirsiniz. Müşteri sizin markanızla tanışır." },
        ...
        tiers: [
            {
                ...
                how: "Referral linkinizle müşteri yönlendirirsiniz. Satış AmeritAI tarafından yapılır.",
                features: [
            ...
            },
            {
                ...
                how: "Kurulum, entegrasyon ve optimizasyon yaparsınız. Enterprise anlaşmalarını AmeritAI ile birlikte satarsınız.",
                features: [
                    "Tam API erişimi",
                    "Sandbox ortamı",
        ...
        rules: [
            "Partnerler resmi liste fiyatının altına inemez. İndirim yetkisi AmeritAI'a aittir.",
            ...
            "Enterprise co-sell anlaşmazlıklarında AmeritAI hakemlik yapar, Çözüm Partneri önceliklendirilir.",
    ...
    en: {
        ...
        hero_title: "Grow with AmeritAI, Earn Together",
        ...
        why_title: "Why Become a AmeritAI Partner?",
        why_items: [
            ...
            { icon: Crown, title: "Customer Ownership", desc: "The customer you bring is yours. No other partner or AmeritAI direct sales team can interfere for 12 months." },
            { icon: Globe, title: "White Label Option", desc: "As a Solution Partner, you can present AmeritAI under your own brand. The customer meets your brand first." },
        ...
        tiers: [
            {
                ...
                how: "You refer customers via your referral link. AmeritAI closes the sale.",
                features: [
            ...
            },
            {
                ...
                how: "You handle setup, integration, and optimization. You co-sell Enterprise deals with AmeritAI.",
                features: [
                    "Full API access",
                    "Sandbox environment",
        ...
        rules: [
            "Partners cannot go below official list price. Discount authority belongs to AmeritAI.",
            ...
            "In co-sell disputes, AmeritAI mediates and Solution Partner is prioritized.",
