            ...
            try {
                ...
                if (res.ok) {
                    ...
                    const nextSettings: ChatbotSettings = {
                        ...
                        welcomeTitleLocalized: data.welcomeTitleLocalized || { tr: "", en: "" },
                        welcomeMessage: data.welcomeMessage || "Hello! How can I help you today?",
                        welcomeMessageLocalized: data.welcomeMessageLocalized || { tr: "", en: "" },
                        ...
                        suggestedQuestionsLocalized: data.suggestedQuestionsLocalized || { tr: [], en: [] },
                        ...
                        voiceProfile: ["support", "sales", "appointments", "restaurant"].includes(data.voiceProfile) ? data.voiceProfile : "support",
                        ...
                        ambientPlaceholderTextLocalized: data.ambientPlaceholderTextLocalized || { tr: "", en: "" },
