...
import { Loader2, RefreshCw, Rss, ShoppingBag, FileText, Plus, ArrowLeft } from "lucide-react"
        ...
        <div className="p-8 space-y-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
                ...
                <TabsContent value="overview" className="space-y-4">
                    <ShopperDashboard onNavigateToCatalog={() => setActiveTab("catalog")} targetUserId={effectiveUserId} />
                </TabsContent>
