...
interface VisualDiagnosisToolProps {
    ...
    // as it's a direct API call with the image, but we might pass it for consistency or logging if needed.
    targetUserId?: string
    isSuperAdmin?: boolean
}

export function VisualDiagnosisTool({ targetUserId, isSuperAdmin = false }: VisualDiagnosisToolProps) {
    const { t } = useLanguage()
