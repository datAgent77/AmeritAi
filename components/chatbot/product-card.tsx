...
const LABELS: Record<SupportedLang, { viewDetails: string; detailsUnavailable: string; viewProductTitle: string; soldOut: string; lastItems: (count: number) => string }> = {
    tr: {
        viewDetails: "Ürünü İncele",
        detailsUnavailable: "Detay Bulunamadı",
        viewProductTitle: "Ürünü yeni sekmede incele",
        soldOut: "Tükendi",
    ...
    en: {
        ...
        viewProductTitle: "View product in a new tab",
        soldOut: "Sold out",
    ...
    de: {
        ...
        viewProductTitle: "Produkt in neuem Tab ansehen",
        soldOut: "Ausverkauft",
    ...
    fr: {
        ...
        viewProductTitle: "Voir le produit dans un nouvel onglet",
        soldOut: "Épuisé",
        lastItems: (count) => `Plus que ${count}`,
    },
    es: {
        viewDetails: "Ver producto",
        detailsUnavailable: "Detalle no disponible",
        viewProductTitle: "Ver producto en una nueva pestaña",
        soldOut: "Agotado",
