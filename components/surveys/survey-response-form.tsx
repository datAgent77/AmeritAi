...
export function SurveyResponseForm({
    ...
    return (
        <Card className={cn(mode === "widget" && "border-none bg-transparent shadow-none")}>
            <CardHeader className={cn("space-y-4", mode === "widget" && "px-0 pt-0")}>
                {showSurveyHeader && (
            ...
            <CardContent className={cn("space-y-6", mode === "widget" && "px-0 pb-0")}>
                {isIntroStep && (
                ...
                <div className="flex flex-col-reverse gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    {stepIndex < totalSteps - 1 ? (
                        <Button type="button" onClick={handleNext} className="w-full text-white shadow-md hover:opacity-90 sm:w-auto" style={{ backgroundColor: brandColor }}>
                            {copy.next}
                            <ArrowRight className="ml-2 h-4 w-4" />
                        </Button>
                    ) : (
                        <Button type="button" onClick={handleSubmit} disabled={isSubmitting} className="w-full text-white shadow-md hover:opacity-90 sm:w-auto" style={{ backgroundColor: brandColor }}>
